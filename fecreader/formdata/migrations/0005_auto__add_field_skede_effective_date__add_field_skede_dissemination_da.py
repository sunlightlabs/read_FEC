...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SkedE.effective_date'
        db.add_column(u'formdata_skede', 'effective_date',
                      self.gf('django.db.models.fields.DateField')(null=True),
                      keep_default=False)

        # Adding field 'SkedE.dissemination_date'
        db.add_column(u'formdata_skede', 'dissemination_date',
                      self.gf('django.db.models.fields.CharField')(max_length=8, null=True, blank=True),
                      keep_default=False)

        # Adding field 'SkedE.dissemination_date_formatted'
        db.add_column(u'formdata_skede', 'dissemination_date_formatted',
                      self.gf('django.db.models.fields.DateField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SkedE.effective_date'
        db.delete_column(u'formdata_skede', 'effective_date')

        # Deleting field 'SkedE.dissemination_date'
        db.delete_column(u'formdata_skede', 'dissemination_date')

        # Deleting field 'SkedE.dissemination_date_formatted'
        db.delete_column(u'formdata_skede', 'dissemination_date_formatted')
    ...
    models = {
        ...
        u'formdata.skede': {
            ...
            'dissemination_date': ('django.db.models.fields.CharField', [], {'max_length': '8', 'null': 'True', 'blank': 'True'}),
            'dissemination_date_formatted': ('django.db.models.fields.DateField', [], {'null': 'True'}),
