...
urlpatterns = patterns('',
        ...
        url(r'^outside-spenders/$', 'public_views.datapages.views.outside_spenders_redirect'),
        url(r'^outside-spenders/(?P<cycle>201\d)\/$', 'public_views.datapages.views.outside_spenders'),        
        ...
        url(r'^download-index/(?P<cycle>201\d)\/$', 'public_views.datapages.views.downloads'),        
        url(r'^download-index\/$', 'public_views.datapages.views.downloads_redirect'),        
       ...
       TemplateView.as_view(template_name='generated_pages/overview_connected_template.html')),
