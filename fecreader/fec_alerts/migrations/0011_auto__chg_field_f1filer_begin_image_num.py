...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'f1filer.begin_image_num'
        db.alter_column(u'fec_alerts_f1filer', 'begin_image_num', self.gf('django.db.models.fields.CharField')(max_length=31))

    def backwards(self, orm):

        # Changing field 'f1filer.begin_image_num'
        db.alter_column(u'fec_alerts_f1filer', 'begin_image_num', self.gf('django.db.models.fields.CharField')(max_length=15))
    ...
    models = {
        u'fec_alerts.f1filer': {
            ...
            'begin_image_num': ('django.db.models.fields.CharField', [], {'max_length': '31'}),
            ...
            'cycle': ('django.db.models.fields.CharField', [], {'default': "'2016'", 'max_length': '4'}),
