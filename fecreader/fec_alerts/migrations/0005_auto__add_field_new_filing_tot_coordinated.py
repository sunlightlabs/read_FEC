...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'new_filing.tot_coordinated'
        db.add_column(u'fec_alerts_new_filing', 'tot_coordinated',
                      self.gf('django.db.models.fields.DecimalField')(default=0, null=True, max_digits=14, decimal_places=2),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'new_filing.tot_coordinated'
        db.delete_column(u'fec_alerts_new_filing', 'tot_coordinated')
