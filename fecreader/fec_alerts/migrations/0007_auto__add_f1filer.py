...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'f1filer'
        db.create_table(u'fec_alerts_f1filer', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('cycle', self.gf('django.db.models.fields.CharField')(default='2014', max_length=4)),
            ('cmte_id', self.gf('django.db.models.fields.CharField')(unique=True, max_length=9, blank=True)),
            ('cmte_nm', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('cmte_st1', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('cmte_st2', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('cmte_city', self.gf('django.db.models.fields.CharField')(max_length=63, null=True, blank=True)),
            ('cmte_st', self.gf('django.db.models.fields.CharField')(max_length=5, null=True, blank=True)),
            ('cmte_zip', self.gf('django.db.models.fields.CharField')(max_length=15, null=True, blank=True)),
            ('affiliated_cmte_nm', self.gf('django.db.models.fields.CharField')(max_length=61, null=True, blank=True)),
            ('filed_cmte_tp', self.gf('django.db.models.fields.CharField')(max_length=2)),
            ('filed_cmte_dsgn', self.gf('django.db.models.fields.CharField')(max_length=2)),
            ('filing_freq', self.gf('django.db.models.fields.CharField')(max_length=2, null=True, blank=True)),
            ('org_tp', self.gf('django.db.models.fields.CharField')(max_length=2, null=True, blank=True)),
            ('tres_nm', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('receipt_dt', self.gf('django.db.models.fields.DateField')(null=True, blank=True)),
            ('cmte_email', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('cmte_web_url', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('begin_image_num', self.gf('django.db.models.fields.CharField')(max_length=15)),
        ))
        db.send_create_signal(u'fec_alerts', ['f1filer'])


    def backwards(self, orm):
        # Deleting model 'f1filer'
        db.delete_table(u'fec_alerts_f1filer')


    models = {
        u'fec_alerts.f1filer': {
            'Meta': {'object_name': 'f1filer'},
            'affiliated_cmte_nm': ('django.db.models.fields.CharField', [], {'max_length': '61', 'null': 'True', 'blank': 'True'}),
