...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'new_filing.ie_rows_processed'
        db.add_column(u'fec_alerts_new_filing', 'ie_rows_processed',
                      self.gf('django.db.models.fields.NullBooleanField')(default=False, null=True, blank=True),
                      keep_default=False)

        # Adding field 'new_filing.tot_ies'
        db.add_column(u'fec_alerts_new_filing', 'tot_ies',
                      self.gf('django.db.models.fields.DecimalField')(default=0, null=True, max_digits=14, decimal_places=2),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'new_filing.ie_rows_processed'
        db.delete_column(u'fec_alerts_new_filing', 'ie_rows_processed')

        # Deleting field 'new_filing.tot_ies'
        db.delete_column(u'fec_alerts_new_filing', 'tot_ies')
