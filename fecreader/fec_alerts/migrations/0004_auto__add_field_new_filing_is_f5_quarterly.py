...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'new_filing.is_f5_quarterly'
        db.add_column(u'fec_alerts_new_filing', 'is_f5_quarterly',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'new_filing.is_f5_quarterly'
        db.delete_column(u'fec_alerts_new_filing', 'is_f5_quarterly')
