...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Committee_Overlay.is_dirty'
        db.add_column(u'summary_data_committee_overlay', 'is_dirty',
                      self.gf('django.db.models.fields.NullBooleanField')(default=True, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Committee_Overlay.is_dirty'
        db.delete_column(u'summary_data_committee_overlay', 'is_dirty')
