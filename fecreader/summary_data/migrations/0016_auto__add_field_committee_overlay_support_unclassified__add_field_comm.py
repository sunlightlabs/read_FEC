...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Committee_Overlay.support_unclassified'
        db.add_column(u'summary_data_committee_overlay', 'support_unclassified',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=19, decimal_places=2),
                      keep_default=False)

        # Adding field 'Committee_Overlay.oppose_unclassified'
        db.add_column(u'summary_data_committee_overlay', 'oppose_unclassified',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=19, decimal_places=2),
                      keep_default=False)

        # Adding field 'Committee_Overlay.support_winners'
        db.add_column(u'summary_data_committee_overlay', 'support_winners',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=19, decimal_places=2),
                      keep_default=False)

        # Adding field 'Committee_Overlay.oppose_winners'
        db.add_column(u'summary_data_committee_overlay', 'oppose_winners',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=19, decimal_places=2),
                      keep_default=False)

        # Adding field 'Committee_Overlay.support_losers'
        db.add_column(u'summary_data_committee_overlay', 'support_losers',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=19, decimal_places=2),
                      keep_default=False)

        # Adding field 'Committee_Overlay.oppose_losers'
        db.add_column(u'summary_data_committee_overlay', 'oppose_losers',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=19, decimal_places=2),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Committee_Overlay.support_unclassified'
        db.delete_column(u'summary_data_committee_overlay', 'support_unclassified')

        # Deleting field 'Committee_Overlay.oppose_unclassified'
        db.delete_column(u'summary_data_committee_overlay', 'oppose_unclassified')

        # Deleting field 'Committee_Overlay.support_winners'
        db.delete_column(u'summary_data_committee_overlay', 'support_winners')

        # Deleting field 'Committee_Overlay.oppose_winners'
        db.delete_column(u'summary_data_committee_overlay', 'oppose_winners')

        # Deleting field 'Committee_Overlay.support_losers'
        db.delete_column(u'summary_data_committee_overlay', 'support_losers')

        # Deleting field 'Committee_Overlay.oppose_losers'
        db.delete_column(u'summary_data_committee_overlay', 'oppose_losers')
    ...
    models = {
        ...
        u'summary_data.committee_overlay': {
            ...
            'oppose_losers': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '19', 'decimal_places': '2'}),
            'oppose_unclassified': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '19', 'decimal_places': '2'}),
            'oppose_winners': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '19', 'decimal_places': '2'}),
            ...
            'support_losers': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '19', 'decimal_places': '2'}),
            'support_unclassified': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '19', 'decimal_places': '2'}),
            'support_winners': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '19', 'decimal_places': '2'}),
            'term_class': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            'total_contributions': ('django.db.models.fields.DecimalField', [], {'default': '0', 'null': 'True', 'max_digits': '19', 'decimal_places': '2'}),
        ...
        u'summary_data.district': {
            ...
            'general_is_decided': ('django.db.models.fields.NullBooleanField', [], {'default': 'False', 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'summary_data.electionsummary': {
            ...
            'election_winner': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['summary_data.Candidate_Overlay']", 'null': 'True', 'blank': 'True'}),
            'election_year': ('django.db.models.fields.IntegerField', [], {}),
        ...
        u'summary_data.roi_pair': {
            'Meta': {'object_name': 'roi_pair'},
            'candidate': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['summary_data.Candidate_Overlay']"}),
            'committee': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['summary_data.Committee_Overlay']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'support_oppose': ('django.db.models.fields.CharField', [], {'max_length': '1'}),
