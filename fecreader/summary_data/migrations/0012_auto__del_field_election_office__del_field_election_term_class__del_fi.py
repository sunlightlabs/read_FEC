...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'summary_data_election', 'office')

        # Deleting field 'Election.term_class'
        db.delete_column(u'summary_data_election', 'term_class')

        # Deleting field 'Election.office_district'
        db.delete_column(u'summary_data_election', 'office_district')

        # Deleting field 'Election.seat_redistricted'
        db.delete_column(u'summary_data_election', 'seat_redistricted')

        # Deleting field 'Election.state'
        db.delete_column(u'summary_data_election', 'state')

        # Deleting field 'Election.incumbent_name'
        db.delete_column(u'summary_data_election', 'incumbent_name')

        # Deleting field 'Election.incumbent_party'
        db.delete_column(u'summary_data_election', 'incumbent_party')

        # Deleting field 'Election.primary_party'
        db.delete_column(u'summary_data_election', 'primary_party')

        # Deleting field 'Election.open_seat'
        db.delete_column(u'summary_data_election', 'open_seat')

        # Deleting field 'Election.seat_isnew'
        db.delete_column(u'summary_data_election', 'seat_isnew')


    def backwards(self, orm):
        # Adding field 'Election.office'
        db.add_column(u'summary_data_election', 'office',
                      self.gf('django.db.models.fields.CharField')(max_length=1, null=True),
                      keep_default=False)

        # Adding field 'Election.term_class'
        db.add_column(u'summary_data_election', 'term_class',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Election.office_district'
        db.add_column(u'summary_data_election', 'office_district',
                      self.gf('django.db.models.fields.CharField')(max_length=2, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Election.seat_redistricted'
        db.add_column(u'summary_data_election', 'seat_redistricted',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Election.state'
        db.add_column(u'summary_data_election', 'state',
                      self.gf('django.db.models.fields.CharField')(max_length=2, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Election.incumbent_name'
        db.add_column(u'summary_data_election', 'incumbent_name',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Election.incumbent_party'
        db.add_column(u'summary_data_election', 'incumbent_party',
                      self.gf('django.db.models.fields.CharField')(max_length=1, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Election.primary_party'
        db.add_column(u'summary_data_election', 'primary_party',
                      self.gf('django.db.models.fields.CharField')(max_length=1, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Election.open_seat'
        db.add_column(u'summary_data_election', 'open_seat',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Election.seat_isnew'
        db.add_column(u'summary_data_election', 'seat_isnew',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)
    ...
    models = {
        ...
        u'summary_data.election': {
            ...
            'election_winner': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['summary_data.Candidate_Overlay']"}),
            'election_year': ('django.db.models.fields.IntegerField', [], {}),
            'has_open_voting_period': ('django.db.models.fields.NullBooleanField', [], {'default': 'False', 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
