...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'roi_pair'
        db.create_table(u'summary_data_roi_pair', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('committee', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['summary_data.Committee_Overlay'])),
        ...
        db.send_create_signal(u'summary_data', ['roi_pair'])


    def backwards(self, orm):
        # Deleting model 'roi_pair'
        db.delete_table(u'summary_data_roi_pair')
