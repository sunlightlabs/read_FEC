...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Election.has_open_voting_period'
        db.delete_column(u'summary_data_election', 'has_open_voting_period')

        # Deleting field 'Election.election_voting_start_date'
        db.delete_column(u'summary_data_election', 'election_voting_start_date')

        # Deleting field 'Election.election_voting_end_date'
        db.delete_column(u'summary_data_election', 'election_voting_end_date')


        # Changing field 'Election.election_winner'
        db.alter_column(u'summary_data_election', 'election_winner_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['summary_data.Candidate_Overlay'], null=True))
        # Adding field 'ElectionSummary.has_primary_runoff'
        db.add_column(u'summary_data_electionsummary', 'has_primary_runoff',
                      self.gf('django.db.models.fields.NullBooleanField')(default=False, null=True, blank=True),
                      keep_default=False)

        # Adding field 'ElectionSummary.primary_runoff_date'
        db.add_column(u'summary_data_electionsummary', 'primary_runoff_date',
                      self.gf('django.db.models.fields.DateField')(null=True),
                      keep_default=False)

        # Adding field 'ElectionSummary.primary_runoff_needed'
        db.add_column(u'summary_data_electionsummary', 'primary_runoff_needed',
                      self.gf('django.db.models.fields.NullBooleanField')(default=False, null=True, blank=True),
                      keep_default=False)

        # Adding field 'ElectionSummary.has_general_runoff'
        db.add_column(u'summary_data_electionsummary', 'has_general_runoff',
                      self.gf('django.db.models.fields.NullBooleanField')(default=False, null=True, blank=True),
                      keep_default=False)

        # Adding field 'ElectionSummary.general_runoff_date'
        db.add_column(u'summary_data_electionsummary', 'general_runoff_date',
                      self.gf('django.db.models.fields.DateField')(null=True),
                      keep_default=False)

        # Adding field 'ElectionSummary.general_runoff_needed'
        db.add_column(u'summary_data_electionsummary', 'general_runoff_needed',
                      self.gf('django.db.models.fields.NullBooleanField')(default=False, null=True, blank=True),
                      keep_default=False)


        # Changing field 'ElectionSummary.election_winner'
        db.alter_column(u'summary_data_electionsummary', 'election_winner_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['summary_data.Candidate_Overlay'], null=True))

    def backwards(self, orm):
        # Adding field 'Election.has_open_voting_period'
        db.add_column(u'summary_data_election', 'has_open_voting_period',
                      self.gf('django.db.models.fields.NullBooleanField')(default=False, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Election.election_voting_start_date'
        db.add_column(u'summary_data_election', 'election_voting_start_date',
                      self.gf('django.db.models.fields.DateField')(null=True),
                      keep_default=False)

        # Adding field 'Election.election_voting_end_date'
        db.add_column(u'summary_data_election', 'election_voting_end_date',
                      self.gf('django.db.models.fields.DateField')(null=True),
                      keep_default=False)


        # User chose to not deal with backwards NULL issues for 'Election.election_winner'
        raise RuntimeError("Cannot reverse this migration. 'Election.election_winner' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'Election.election_winner'
        db.alter_column(u'summary_data_election', 'election_winner_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['summary_data.Candidate_Overlay']))
        # Deleting field 'ElectionSummary.has_primary_runoff'
        db.delete_column(u'summary_data_electionsummary', 'has_primary_runoff')

        # Deleting field 'ElectionSummary.primary_runoff_date'
        db.delete_column(u'summary_data_electionsummary', 'primary_runoff_date')

        # Deleting field 'ElectionSummary.primary_runoff_needed'
        db.delete_column(u'summary_data_electionsummary', 'primary_runoff_needed')

        # Deleting field 'ElectionSummary.has_general_runoff'
        db.delete_column(u'summary_data_electionsummary', 'has_general_runoff')

        # Deleting field 'ElectionSummary.general_runoff_date'
        db.delete_column(u'summary_data_electionsummary', 'general_runoff_date')

        # Deleting field 'ElectionSummary.general_runoff_needed'
        db.delete_column(u'summary_data_electionsummary', 'general_runoff_needed')


        # User chose to not deal with backwards NULL issues for 'ElectionSummary.election_winner'
        raise RuntimeError("Cannot reverse this migration. 'ElectionSummary.election_winner' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'ElectionSummary.election_winner'
        db.alter_column(u'summary_data_electionsummary', 'election_winner_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['summary_data.Candidate_Overlay']))
    ...
    models = {
        ...
        u'summary_data.districtweekly': {
            'Meta': {'object_name': 'DistrictWeekly'},
            'coordinated_spending': ('django.db.models.fields.DecimalField', [], {'default': '0', 'null': 'True', 'max_digits': '19', 'decimal_places': '2'}),
            'cycle_week_number': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
        ...
        u'summary_data.election': {
            ...
            'cycle': ('django.db.models.fields.CharField', [], {'max_length': '4', 'null': 'True', 'blank': 'True'}),
            'district': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['summary_data.District']"}),
            'election': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['summary_data.ElectionSummary']"}),
            'election_code': ('django.db.models.fields.CharField', [], {'max_length': '2', 'null': 'True', 'blank': 'True'}),
            ...
            'election_party': ('django.db.models.fields.CharField', [], {'max_length': '1', 'null': 'True', 'blank': 'True'}),
            'election_winner': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['summary_data.Candidate_Overlay']", 'null': 'True'}),
        ...
        u'summary_data.electionsummary': {
            'Meta': {'object_name': 'ElectionSummary'},
            'candidate_raised': ('django.db.models.fields.DecimalField', [], {'default': '0', 'null': 'True', 'max_digits': '19', 'decimal_places': '2'}),
            'candidate_spending': ('django.db.models.fields.DecimalField', [], {'default': '0', 'null': 'True', 'max_digits': '19', 'decimal_places': '2'}),
            'coordinated_spending': ('django.db.models.fields.DecimalField', [], {'default': '0', 'null': 'True', 'max_digits': '19', 'decimal_places': '2'}),
            'cycle': ('django.db.models.fields.CharField', [], {'max_length': '4', 'null': 'True', 'blank': 'True'}),
            ...
            'election_date': ('django.db.models.fields.DateField', [], {'null': 'True'}),
            'election_party': ('django.db.models.fields.CharField', [], {'max_length': '1', 'null': 'True', 'blank': 'True'}),
            'election_summary_code': ('django.db.models.fields.CharField', [], {'max_length': '2', 'null': 'True', 'blank': 'True'}),
            'election_winner': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['summary_data.Candidate_Overlay']", 'null': 'True'}),
            'election_year': ('django.db.models.fields.IntegerField', [], {}),
            'general_runoff_date': ('django.db.models.fields.DateField', [], {'null': 'True'}),
            'general_runoff_needed': ('django.db.models.fields.NullBooleanField', [], {'default': 'False', 'null': 'True', 'blank': 'True'}),
            'has_general_runoff': ('django.db.models.fields.NullBooleanField', [], {'default': 'False', 'null': 'True', 'blank': 'True'}),
            'has_primary_runoff': ('django.db.models.fields.NullBooleanField', [], {'default': 'False', 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'incumbent_name': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
            'incumbent_party': ('django.db.models.fields.CharField', [], {'max_length': '1', 'null': 'True', 'blank': 'True'}),
            'outside_spending': ('django.db.models.fields.DecimalField', [], {'default': '0', 'null': 'True', 'max_digits': '19', 'decimal_places': '2'}),
            'primary_runoff_date': ('django.db.models.fields.DateField', [], {'null': 'True'}),
            'primary_runoff_needed': ('django.db.models.fields.NullBooleanField', [], {'default': 'False', 'null': 'True', 'blank': 'True'}),
            'total_spending': ('django.db.models.fields.DecimalField', [], {'default': '0', 'null': 'True', 'max_digits': '19', 'decimal_places': '2'})
        },
