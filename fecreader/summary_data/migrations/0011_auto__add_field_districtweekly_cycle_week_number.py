...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DistrictWeekly.cycle_week_number'
        db.add_column(u'summary_data_districtweekly', 'cycle_week_number',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DistrictWeekly.cycle_week_number'
        db.delete_column(u'summary_data_districtweekly', 'cycle_week_number')
