...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Authorized_Candidate_Committees.cycle'
        db.add_column(u'summary_data_authorized_candidate_committees', 'cycle',
                      self.gf('django.db.models.fields.CharField')(max_length=4, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Authorized_Candidate_Committees.cycle'
        db.delete_column(u'summary_data_authorized_candidate_committees', 'cycle')
    ...
    models = {
        ...
        u'summary_data.committee_overlay': {
            ...
            'roi': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '19', 'decimal_places': '2'}),
