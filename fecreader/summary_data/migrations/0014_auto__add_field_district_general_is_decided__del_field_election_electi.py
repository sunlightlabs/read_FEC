...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'District.general_is_decided'
        db.add_column(u'summary_data_district', 'general_is_decided',
                      self.gf('django.db.models.fields.NullBooleanField')(default=False, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Election.election_party'
        db.delete_column(u'summary_data_election', 'election_party')

        # Deleting field 'ElectionSummary.election_party'
        db.delete_column(u'summary_data_electionsummary', 'election_party')


    def backwards(self, orm):
        # Deleting field 'District.general_is_decided'
        db.delete_column(u'summary_data_district', 'general_is_decided')

        # Adding field 'Election.election_party'
        db.add_column(u'summary_data_election', 'election_party',
                      self.gf('django.db.models.fields.CharField')(max_length=1, null=True, blank=True),
                      keep_default=False)

        # Adding field 'ElectionSummary.election_party'
        db.add_column(u'summary_data_electionsummary', 'election_party',
                      self.gf('django.db.models.fields.CharField')(max_length=1, null=True, blank=True),
                      keep_default=False)
