...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Candidate_Overlay.display'
        db.add_column(u'summary_data_candidate_overlay', 'display',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Candidate_Overlay.display'
        db.delete_column(u'summary_data_candidate_overlay', 'display')
