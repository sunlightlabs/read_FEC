...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'District.district_notes'
        db.add_column(u'summary_data_district', 'district_notes',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'District.district_notes'
        db.delete_column(u'summary_data_district', 'district_notes')
