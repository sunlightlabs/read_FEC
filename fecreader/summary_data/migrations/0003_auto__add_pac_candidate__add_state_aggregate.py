...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'summary_data_pac_candidate', (
            ...
            ('total_coord_exp', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=19, decimal_places=2)),
        ))
        db.send_create_signal(u'summary_data', ['Pac_Candidate'])

        # Adding model 'State_Aggregate'
        db.create_table(u'summary_data_state_aggregate', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('cycle', self.gf('django.db.models.fields.CharField')(max_length=4, null=True, blank=True)),
            ...
            ('total_ec', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=19, decimal_places=2)),
            ('total_coord', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=19, decimal_places=2)),
        ))
        db.send_create_signal(u'summary_data', ['State_Aggregate'])


    def backwards(self, orm):
        # Deleting model 'Pac_Candidate'
        db.delete_table(u'summary_data_pac_candidate')

        # Deleting model 'State_Aggregate'
        db.delete_table(u'summary_data_state_aggregate')
