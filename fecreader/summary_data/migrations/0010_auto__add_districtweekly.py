...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'DistrictWeekly'
        db.create_table(u'summary_data_districtweekly', (
        ...
        db.send_create_signal(u'summary_data', ['DistrictWeekly'])


    def backwards(self, orm):
        # Deleting model 'DistrictWeekly'
        db.delete_table(u'summary_data_districtweekly')
