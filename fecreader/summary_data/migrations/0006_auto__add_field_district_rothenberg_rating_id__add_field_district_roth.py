...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'District.rothenberg_rating_id'
        db.add_column(u'summary_data_district', 'rothenberg_rating_id',
                      self.gf('django.db.models.fields.IntegerField')(null=True),
                      keep_default=False)

        # Adding field 'District.rothenberg_rating_text'
        db.add_column(u'summary_data_district', 'rothenberg_rating_text',
                      self.gf('django.db.models.fields.CharField')(max_length=63, null=True),
                      keep_default=False)

        # Adding field 'District.rothenberg_update_time'
        db.add_column(u'summary_data_district', 'rothenberg_update_time',
                      self.gf('django.db.models.fields.DateTimeField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'District.rothenberg_rating_id'
        db.delete_column(u'summary_data_district', 'rothenberg_rating_id')

        # Deleting field 'District.rothenberg_rating_text'
        db.delete_column(u'summary_data_district', 'rothenberg_rating_text')

        # Deleting field 'District.rothenberg_update_time'
        db.delete_column(u'summary_data_district', 'rothenberg_update_time')
