...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Committee_Overlay.roi'
        db.add_column(u'summary_data_committee_overlay', 'roi',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=19, decimal_places=2),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Committee_Overlay.roi'
        db.delete_column(u'summary_data_committee_overlay', 'roi')
