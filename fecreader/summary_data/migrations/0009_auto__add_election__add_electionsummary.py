...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'summary_data_election', (
            ...
            ('election', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['summary_data.ElectionSummary'])),
            ...
            ('election_winner', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['summary_data.Candidate_Overlay'])),
            ('election_party', self.gf('django.db.models.fields.CharField')(max_length=1, null=True, blank=True)),
            ...
            ('has_open_voting_period', self.gf('django.db.models.fields.NullBooleanField')(default=False, null=True, blank=True)),
            ...
            ('election_code', self.gf('django.db.models.fields.CharField')(max_length=2, null=True, blank=True)),
            ...
            ('candidate_raised', self.gf('django.db.models.fields.DecimalField')(default=0, null=True, max_digits=19, decimal_places=2)),
            ('candidate_spending', self.gf('django.db.models.fields.DecimalField')(default=0, null=True, max_digits=19, decimal_places=2)),
            ('outside_spending', self.gf('django.db.models.fields.DecimalField')(default=0, null=True, max_digits=19, decimal_places=2)),
            ('total_spending', self.gf('django.db.models.fields.DecimalField')(default=0, null=True, max_digits=19, decimal_places=2)),
            ('coordinated_spending', self.gf('django.db.models.fields.DecimalField')(default=0, null=True, max_digits=19, decimal_places=2)),
        ))
        db.send_create_signal(u'summary_data', ['Election'])

        # Adding model 'ElectionSummary'
        db.create_table(u'summary_data_electionsummary', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('district', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['summary_data.District'])),
            ('incumbent_name', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('incumbent_party', self.gf('django.db.models.fields.CharField')(max_length=1, null=True, blank=True)),
            ...
            ('election_year', self.gf('django.db.models.fields.IntegerField')()),
            ('election_date', self.gf('django.db.models.fields.DateField')(null=True)),
            ('election_summary_code', self.gf('django.db.models.fields.CharField')(max_length=2, null=True, blank=True)),
            ('candidate_raised', self.gf('django.db.models.fields.DecimalField')(default=0, null=True, max_digits=19, decimal_places=2)),
            ('candidate_spending', self.gf('django.db.models.fields.DecimalField')(default=0, null=True, max_digits=19, decimal_places=2)),
            ('outside_spending', self.gf('django.db.models.fields.DecimalField')(default=0, null=True, max_digits=19, decimal_places=2)),
            ('total_spending', self.gf('django.db.models.fields.DecimalField')(default=0, null=True, max_digits=19, decimal_places=2)),
        ...
        db.send_create_signal(u'summary_data', ['ElectionSummary'])
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'ElectionSummary'
        db.delete_table(u'summary_data_electionsummary')
